...
module PryTheme
  ...
  DEF_THEMES_DIR = ::T.let(nil, ::T.untyped)
  PTC = ::T.let(nil, ::T.untyped)
  PT_EXT = ::T.let(nil, ::T.untyped)
  ROOT = ::T.let(nil, ::T.untyped)
  SHORTENER = ::T.let(nil, ::T.untyped)
  USER_THEMES_DIR = ::T.let(nil, ::T.untyped)
  VERSION = ::T.let(nil, ::T.untyped)
...
class PryTheme::RGB
  BYTEPOINTS_256 = ::T.let(nil, ::T.untyped)
  COLORS = ::T.let(nil, ::T.untyped)
...
class PryTheme::Theme::Definition::Regexp
  ATTRS = ::T.let(nil, ::T.untyped)
end
